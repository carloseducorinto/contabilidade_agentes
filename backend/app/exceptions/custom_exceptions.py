...
class ClassificationError(ContabilidadeBaseException):
    """Erro específico na classificação de documentos"""
    pass


class LLMIntegrationError(ExternalAPIError):
    """Erro na integração com modelos de linguagem grandes (LLM)"""
    pass
