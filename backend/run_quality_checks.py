...
def main():
    ...
    checks = [
        ...
        ("pytest tests/unit/test_classification_agent.py -v", "Testes unitários do ClassificationAgent"),
        ("pytest tests/integration/ -v", "Testes de integração"),
        ("pytest tests/integration/test_classification_flow.py -v", "Testes de integração do fluxo de classificação"),
